			...
			{showModal && (
				...
				>
					<div
						...
						className="bg-gris border-2 border-white/15 rounded-lg p-6 max-w-sm w-full space-y-4 shadow-[4px_4px_0_#FE0000] max-h-[85svh] overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
					>
