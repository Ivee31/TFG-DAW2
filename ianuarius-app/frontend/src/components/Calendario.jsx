        ...
        <div className="space-y-6">
            ...
            {modalDia && (
                <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
                    ...
                    <div ref={modalAddRef} role="dialog" aria-modal="true" aria-label="Añadir evento" className="relative bg-gris border-2 border-white/15 rounded-lg p-6 w-full max-w-md shadow-[4px_4px_0_#FE0000] max-h-[85svh] overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            ...
            {detalleData && (
                <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
                    ...
                    <div ref={modalDetalleRef} role="dialog" aria-modal="true" aria-label={eventoActual?.titulo ?? 'Eventos del día'} className="relative bg-gris border-2 border-white/15 rounded-lg p-6 w-full max-w-sm shadow-[4px_4px_0_#FE0000] max-h-[85svh] overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
